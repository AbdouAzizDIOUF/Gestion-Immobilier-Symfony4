...
$instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Repository\\OptionRepository' => function () {
    return ($this->privates['App\\Repository\\OptionRepository'] ?? $this->load('getOptionRepositoryService.php'));
}, 'App\\Repository\\PicturesRepository' => function () {
    return ($this->privates['App\\Repository\\PicturesRepository'] ?? $this->load('getPicturesRepositoryService.php'));
}, 'App\\Repository\\PropertyRepository' => function () {
    return ($this->privates['App\\Repository\\PropertyRepository'] ?? $this->load('getPropertyRepositoryService.php'));
