...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\PropertyFixture(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []]]);
