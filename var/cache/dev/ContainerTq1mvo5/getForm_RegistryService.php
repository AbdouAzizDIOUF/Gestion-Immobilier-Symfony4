...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Form\\ContactType' => function () {
    return ($this->privates['App\\Form\\ContactType'] ?? ($this->privates['App\\Form\\ContactType'] = new \App\Form\ContactType()));
}, 'App\\Form\\OptionType' => function () {
    return ($this->privates['App\\Form\\OptionType'] ?? ($this->privates['App\\Form\\OptionType'] = new \App\Form\OptionType()));
}, 'App\\Form\\PropertySearchType' => function () {
    return ($this->privates['App\\Form\\PropertySearchType'] ?? ($this->privates['App\\Form\\PropertySearchType'] = new \App\Form\PropertySearchType()));
}, 'App\\Form\\PropertyType' => function () {
    return ($this->privates['App\\Form\\PropertyType'] ?? ($this->privates['App\\Form\\PropertyType'] = new \App\Form\PropertyType()));
