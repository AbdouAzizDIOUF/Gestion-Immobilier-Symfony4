...
class __TwigTemplate_676c14a2e592633037ecfbc4ab12d3479b2cda93d701ead74475fa750a96eb9e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    : \$view['form']->humanize(\$name); } ?>
<button type=\"<?php echo isset(\$type) ? \$view->escape(\$type) : 'button' ?>\" <?php echo \$view['form']->block(\$form, 'button_attributes') ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, [], \$translation_domain) : \$label) ?></button>
", "@Framework/Form/button_widget.html.php", "/home/diouf/projet/php/symfony/masuperagence/Symfony4/vendor/symfony/framework-bundle/Resources/views/Form/button_widget.html.php");
    }
}
